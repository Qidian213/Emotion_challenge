...
def trans_crop(data_dir, dst_data_dir, lms_fp, bin='./build/crop_align', processes=32, tgt_h=224, tgt_w=224):
    ...
    for image_path in image_paths:
        ...
        cmds.append(cmd)
##################################################################
        image_path = image_path[:-4] + '_f' + image_path[-4:]
        fn = osp.split(image_path)[-1]
        id = fn.split('_')[1]
...
def main():
    trans_crop('/data/zzg/Emotion_challenge/Training', dst_data_dir='../faces_224/imgs', lms_fp='../faces_224/anns/train_landmark.json',tgt_h=224, tgt_w=224)
    trans_crop(data_dir='/data/zzg/Emotion_challenge/Validation', dst_data_dir='../faces_224/imgs', lms_fp='../faces_224/anns/val_landmark.json', tgt_h=224, tgt_w=224)
    trans_crop(data_dir='/data/zzg/Emotion_challenge/Test', dst_data_dir='../faces_224/imgs', lms_fp='../faces_224/anns/test_landmark.json', tgt_h=224, tgt_w=224)
